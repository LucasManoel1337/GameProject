...
public class JpMissoes extends JPanel {
    ...
    public JpMissoes(GameFrame gameFrame, infoPlayerDto playerInfo) {
        ...
        JLabel lTituloTela = new JLabel("Missões");
        lTituloTela.setFont(new Font("Arial", Font.BOLD, 30));
        lTituloTela.setForeground(Color.BLACK);
        lTituloTela.setBounds(40, 90, 700, 30);  // Coloquei a posição mais alta para que o título fique acima
