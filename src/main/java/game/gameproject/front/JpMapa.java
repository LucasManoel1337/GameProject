...
public class JpMapa extends JPanel {
    ...
    public JpMapa(GameFrame gameFrame, infoPlayerDto playerInfo) {
        ...
        // Criar o título
        JLabel lTituloTela = new JLabel("Mapa");
        lTituloTela.setFont(new Font("Arial", Font.BOLD, 30));
        lTituloTela.setForeground(Color.BLACK);
        lTituloTela.setBounds(60, 90, 700, 30);  // Coloquei a posição mais alta para que o título fique acima
